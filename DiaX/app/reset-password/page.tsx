...
import { HeartPulse, Lock, Check, ArrowLeft } from "lucide-react"
        ...
        <CardContent className="p-8">
          {isSubmitted ? (
            ...
            >
              ...
              <Button
                className="mt-4 bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white"
